...
public class ctrTree {
	private ctrTree leftTree=new ctrTree();
	private ctrTree rightTree=new ctrTree();
	...
	public double getPredictValue(ctrTree root)
	{
		return root.leafValue;
	}
	public double getPredictValue(ctrTree root,ArrayList<String> instance,Boolean isDigit[])
	{
	...
	public ctrTree constructTree(ArrayList<ArrayList<Integer>> leafNodes,ArrayList<Double> leafValues,int K,int splitPoints, Boolean isDigit[],ArrayList<Integer> subIdx,ArrayList<ArrayList<String>> trainData,ArrayList<Double> target,int maxDepth[],int depth)
	{
