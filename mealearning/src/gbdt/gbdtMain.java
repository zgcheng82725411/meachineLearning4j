...
public class gbdtMain {
	...
	private ArrayList<ArrayList<ctrTree>> trees=new ArrayList<ArrayList<ctrTree>>(); //存放所有的树
	...
	public void train()
	{
		for(int i=0;i<max_iter;i++)
		{
			...
			ArrayList<ctrTree> tmpTree=new ArrayList<>();
			...
			for(int j=0;j<this.K;j++)
			{
				...
				ctrTree treeSub=new ctrTree();
				ctrTree iterTree=treeSub.constructTree(leafNodes,leafValues,K,splitPoints, isDigit, subSet, trainData, target,maxdepths,0);
	...
	public void updateFvalue(Boolean isDigit[], ArrayList<Integer> subIdx,ArrayList<ArrayList<Integer>> leafNodes,ArrayList<Double> leafValues,int label,ctrTree root)
	{
